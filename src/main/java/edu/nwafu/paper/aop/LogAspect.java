package edu.nwafu.paper.aop;

import edu.nwafu.paper.PaperApplication;
...
public class LogAspect {
    protected static final Logger logger = LoggerFactory.getLogger(PaperApplication.class);

    @Pointcut("execution(public * edu.nwafu.paper.controller.*.*(..))")
    public void webLog() {
    }
